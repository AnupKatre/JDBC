...
public class ClassicModels {
	public static void main(String[] args) {
		...
		try {
			// === === === === === === ==== Connection === === === === === === ===
			//Way 1 
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/classicmodels?user=root&password=root");
			
			//Way 2
			//String url = "jdbc:mysql://localhost:3306/classicmodels?createDatabaseIfNotExist=true&useSSL=true";
